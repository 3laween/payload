                ...
                return (react_1.default.createElement("div", { className: `${baseClass}__field`, key: i }, locales.map((locale) => {
                    ...
                    return (react_1.default.createElement("div", { className: `${baseClass}__locale`, key: locale },
                        react_1.default.createElement("div", { className: `${baseClass}__locale-value` },
                            react_1.default.createElement(Component, { locale: locale, locales: locales, field: field, fieldComponents: fieldComponents, version: versionLocaleValue, comparison: comparisonLocaleValue, permissions: subFieldPermissions, isRichText: isRichText }))));
                })));
            }
            return (react_1.default.createElement("div", { className: `${baseClass}__field`, key: i },
                react_1.default.createElement(Component, { locales: locales, field: field, fieldComponents: fieldComponents, version: versionValue, comparison: comparisonValue, permissions: subFieldPermissions, isRichText: isRichText })));
        }
        if (field.type === 'tabs') {
